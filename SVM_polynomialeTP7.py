...
# Création du modèle SVM avec le noyau polynomiale
svm_model = SVC(kernel='poly', degree=3, coef0=1.5, C=1.0, gamma='scale')  # degree=3 par défaut pour un noyau polynomial de degré 3
...
plt.title('Student Admission Prediction with Polynomial Decision Regions')
